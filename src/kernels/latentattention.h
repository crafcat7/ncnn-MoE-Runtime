...
[[nodiscard]] Result<void> forward_latent_attention(const WeightStore& weights,
...
[[nodiscard]] Result<void> forward_latent_attention_batch(const WeightStore& weights,
                                                          const CompiledOperatorTable& operators,
                                                          const AttentionBlockPlan& plan,
                                                          ExecutionBackend backend,
                                                          float norm_epsilon,
...
[[nodiscard]] Result<void> forward_dspark_attention(const WeightStore& weights,
                                                    const CompiledOperatorTable& operators,
                                                    const AttentionBlockPlan& plan,
                                                    ExecutionBackend backend,
                                                    float norm_epsilon,
