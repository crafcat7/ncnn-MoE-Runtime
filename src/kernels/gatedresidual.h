...
[[nodiscard]] Result<void> gated_residual_pre(const ActivationBuffer& input,
...
[[nodiscard]] Result<void> gated_residual_post(const ActivationBuffer& branch,
                                               const ActivationBuffer& residual,
                                               const HyperConnectionMix& mix,
                                               uint32_t multiplier,
                                               ActivationBuffer& output);

[[nodiscard]] Result<void> gated_residual_head(const ActivationBuffer& input,
                                               const TensorData& norm_weight,
                                               const TensorData& mix_down_weight,
                                               const TensorData& mix_up_weight,
                                               uint32_t multiplier,
