...
ScopedBfloat16BatchedLinearExecutionCounter::
    ...
    : previous_(current_bfloat16_execution_counter)
{
...
ScopedBfloat16BatchedLinearExecutionCounter::
    ~ScopedBfloat16BatchedLinearExecutionCounter()
{
    current_bfloat16_execution_counter = previous_;
}
...
void record_bfloat16_batched_linear_dispatch() noexcept
{
    ...
    {
        current_bfloat16_execution_counter->dispatch_count_.fetch_add(
            1,
                             ...
                             uint64_t optimization_flags)
{
    ...
    const Bfloat16BatchedLinearPolicy policy = bfloat16_batched_linear_policy(optimization_flags);
    if (policy == Bfloat16BatchedLinearPolicy::Disabled)
        return false;
