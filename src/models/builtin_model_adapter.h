#ifndef NCNN_MOE_BUILTIN_MODEL_ADAPTER_H
#define NCNN_MOE_BUILTIN_MODEL_ADAPTER_H
...
class BuiltinModelAdapter final : public IMoeModelAdapter
{
public:
...
#endif // NCNN_MOE_BUILTIN_MODEL_ADAPTER_H
