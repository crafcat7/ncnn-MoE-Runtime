#ifndef NCNN_MOE_MODELS_MODELADAPTER_DEEPSEEKV4_H
#define NCNN_MOE_MODELS_MODELADAPTER_DEEPSEEKV4_H
...
class DeepSeekV4ModelAdapter final : public ModelAdapter
{
public:
...
#endif // NCNN_MOE_MODELS_MODELADAPTER_DEEPSEEKV4_H
