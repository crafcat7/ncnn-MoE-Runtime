#ifndef NCNN_MOE_MODELS_MODELADAPTER_QWEN4EXP_H
#define NCNN_MOE_MODELS_MODELADAPTER_QWEN4EXP_H
...
class Qwen4ExpModelAdapter final : public ModelAdapter
{
public:
...
#endif // NCNN_MOE_MODELS_MODELADAPTER_QWEN4EXP_H
