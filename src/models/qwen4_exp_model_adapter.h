#ifndef NCNN_MOE_QWEN4_EXP_MODEL_ADAPTER_H
#define NCNN_MOE_QWEN4_EXP_MODEL_ADAPTER_H
...
class Qwen4ExpModelAdapter final : public IMoeModelAdapter
{
public:
...
#endif // NCNN_MOE_QWEN4_EXP_MODEL_ADAPTER_H
