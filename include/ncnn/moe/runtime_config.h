...
// Runtime configuration flags are kept in this public header.
...
inline constexpr uint32_t RuntimeOptionExpertIoMask = RuntimeOptionMemoryMapExperts
                                                      | RuntimeOptionDirectExpertIo
                                                      | RuntimeOptionBufferedExpertIo;
