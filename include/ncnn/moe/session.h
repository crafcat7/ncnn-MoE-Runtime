...
struct SessionStatistics
{
    ...
    uint64_t expert_gpu_cache_restore_failures = 0;
    uint64_t expert_gpu_cache_bytes_uploaded = 0;
    uint64_t expert_gpu_cache_bytes_downloaded = 0;
    uint64_t expert_gpu_cache_restore_time_microseconds = 0;
    uint64_t expert_gpu_cache_mapped_stores = 0;
    uint64_t expert_gpu_cache_mapped_restores = 0;
