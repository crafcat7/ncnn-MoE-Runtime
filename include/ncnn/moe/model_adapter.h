...
public:
    ...
    [[nodiscard]] virtual Result<MoeIR> parse_model(const ModelPackage& package) const = 0;

    [[nodiscard]] virtual Result<WeightMapping> map_weights(const ModelPackage& package, const MoeIR& ir) const = 0;
};
