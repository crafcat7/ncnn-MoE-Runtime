#ifndef NCNN_MOE_FIXTURE_MODEL_ADAPTER_H
#define NCNN_MOE_FIXTURE_MODEL_ADAPTER_H
...
class FixtureModelAdapter final : public IMoeModelAdapter
{
public:
...
#endif // NCNN_MOE_FIXTURE_MODEL_ADAPTER_H
