#ifndef NCNN_MOE_MODELADAPTER_FIXTURE_H
#define NCNN_MOE_MODELADAPTER_FIXTURE_H
...
class FixtureModelAdapter final : public ModelAdapter
{
public:
...
#endif // NCNN_MOE_MODELADAPTER_FIXTURE_H
